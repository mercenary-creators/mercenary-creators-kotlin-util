...
data class TypicodePostData @FrameworkDsl constructor(val userId: Int, val id: Int, val title: String, val body: String) : TypicodeBase<TypicodePostData> {
