...
data class TypicodeCommentData @FrameworkDsl constructor(val postId: Int, val id: Int, val name: String, val email: String, val body: String) : TypicodeBase<TypicodeCommentData> {
    ...
    companion object {
        ...
        @FrameworkDsl
        const val RESULTS = 500

        @FrameworkDsl
        const val SUBPATH = "/comments"
