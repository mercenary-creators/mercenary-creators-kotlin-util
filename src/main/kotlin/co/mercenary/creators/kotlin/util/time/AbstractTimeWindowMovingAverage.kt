...
abstract class AbstractTimeWindowMovingAverage(window: Long, private val wait: TimeUnit = TimeUnit.MILLISECONDS, unit: TimeUnit = TimeUnit.MILLISECONDS, private val moment: () -> Long = System::currentTimeMillis) : TimeWindowMovingAverage {
