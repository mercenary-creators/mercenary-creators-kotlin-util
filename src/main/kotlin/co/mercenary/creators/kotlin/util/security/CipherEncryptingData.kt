...
@IgnoreForSerialize
class CipherEncryptingData @JvmOverloads @FrameworkDsl constructor(secret: SecretKey, algorithm: CipherAlgorithm = CipherAlgorithm.CBC) : CipherEncrypting<ByteArray, ByteArray> {
